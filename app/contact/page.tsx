  ...
  return (
    <main className="mx-auto flex min-h-dvh w-full max-w-3xl flex-col gap-6 px-4 py-16 sm:px-6">
      ...
      <section className="space-y-3 text-sm leading-6 text-muted-foreground">
        <p>
          Email{" "}
          <a className="text-primary-strong underline underline-offset-4" href="mailto:support@upclass.xyz">
            support@upclass.xyz
          </a>{" "}
        ...
        <p>
          ...
          <Link href="/terms" className="text-primary-strong underline underline-offset-4">
            Terms of Service
          </Link>{" "}
          and{" "}
          <Link href="/privacy" className="text-primary-strong underline underline-offset-4">
            Privacy Policy
          </Link>
          .
        </p>
